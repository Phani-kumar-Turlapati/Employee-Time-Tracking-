...
function EditEmployee() {
    ...
    useEffect(() => {
        Axios.get("http://localhost:4000/employeeRoute/update-employee/" + id)
            .then((res) => {
                if (res.status === 200) {
    ...
    const handleSubmit = () => {
        ...
        Axios.put("https://backend-project-zric.onrender.com/employeeRoute/update-employee/" + id, newObj)
            .then((res) => {
                if (res.status === 200) {
