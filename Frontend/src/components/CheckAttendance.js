...
function CheckAttendance() {
  ...
  const fetchEmployeeIds = async () => {
    try {
      const response = await fetch('https://backend-project-zric.onrender.com/timetrackingRoute/employee-ids');
  ...
  const fetchTimeRecords = async (formattedDate, employeeId) => {
    try {
      const response = await fetch(
        `https://backend-project-zric.onrender.com/timetrackingRoute/get-time-by-employee/${employeeId}?date=${formattedDate}`
      );
